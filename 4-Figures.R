...
#--------------------------------------------------------------------------------------------
# Figure 4 - JS-Distance t and t+1
...
ggsave("~/Projects/Anomalous-IUU-Events-Argentina/figures/leading_JS.png", width=6, height=4)
ggsave("~/Projects/Anomalous-IUU-Events-Argentina/figures/leading_JS.pdf", width=6, height=4)
